...
public class AccountsAppAPI : DataBaseConnection
{
    ...
    [WebMethod]
    public DataSet FinancialReportsCommonBalanceSheet(string SKey, int GroupId, int InstId, int DepartmentId, int FinancialYearId, bool IsShowZeroBalance, bool ShowOnlyOpeningBalaces
        , DateTime FromDate, DateTime ToDate, bool IsIncomeExpenditure, int ForInstId, bool IsTrialBalanceSheet, string TGuid, bool IsTrialWithDetailBalance)
    {
        try
        {
            ...
            SqlCommand cm = new SqlCommand("Accounts.FinancialReportsCommonBalanceSheet", con);
            cm.CommandTimeout = 0;
            cm.CommandType = CommandType.StoredProcedure;
            cm.Parameters.AddWithValue("@GroupId", GroupId);
            cm.Parameters.AddWithValue("@InstId", InstId);
    ...
    [WebMethod]
    public DataSet AccountGenreteCommonBalanceSheet(string SKey, int GroupId, int InstId, int DepartmentId, int FinancialYearId, bool IsShowZeroBalance, bool ShowOnlyOpeningBalaces
        , DateTime FromDate, DateTime ToDate, int ForInstId, string TGuid, decimal SurPlusDeficitAmount)
    {
        try
        {
            using (SqlConnection constr = new SqlConnection(con.ConnectionString))
            {
                using (SqlCommand cm = new SqlCommand())
                {
                    cm.Connection = constr;
                    cm.CommandTimeout = 0;
                    cm.CommandText = "Accounts.AccountGenreteCommonBalanceSheet";
                    cm.CommandType = CommandType.StoredProcedure;
                    cm.Parameters.AddWithValue("@GroupId", GroupId);
                    cm.Parameters.AddWithValue("@InstId", InstId);
                    cm.Parameters.AddWithValue("@DepartmentId", DepartmentId);
    ...
    /// <summary>
    /// Function to fill AccountLedgers for Budget Details Page
    /// </summary>
    /// <returns></returns>
    [WebMethod]
    public DataSet AccountLedgerForBudget(string SKey, int InstId, int FinancialYearId)
    {
        try
        {
            ...
            param[0] = new SqlParameter("@InstId", InstId);
            param[1] = new SqlParameter("@FinancialYearId", FinancialYearId);
            ds = SqlHelper.ExecuteDataset(con, CommandType.StoredProcedure, "Accounts.AccountLedgerForBudget", param);
            SKey = "";
        }
        catch (Exception ex)
        {
    ...
    /// <returns></returns>
    [WebMethod]
    public DataSet ViewAccountLedgerForBudget(string SKey, int InstId, int FinancialYearId, int LedgerId)
    {
        try
        {
            param = new SqlParameter[3];
            ...
            param[1] = new SqlParameter("@FinancialYearId", FinancialYearId);
            param[2] = new SqlParameter("@LedgerId", LedgerId);
            ds = SqlHelper.ExecuteDataset(con, CommandType.StoredProcedure, "Accounts.ViewAccountLedgerForBudget", param);
            SKey = "";
        }
        catch (Exception ex)
        {
    ...
    [WebMethod]
    public bool InsertOrUpdateAccountBudget(string SKey,int InstId,int FinancialYearId, int LedgerId,decimal BudgetAmount,
        decimal BudgetAmount_4Months,DateTime InsertDate, decimal Financial0BudgetAmount, decimal Financial1BudgetAmount, decimal Financial2BudgetAmount,
        decimal Financial3BudgetAmount, decimal Financial4BudgetAmount)
    {
        try
        {
            param = new SqlParameter[11];
            ...
            param[1] = new SqlParameter("@FinancialYearId", FinancialYearId);
            param[2] = new SqlParameter("@LedgerId", LedgerId);
            param[3] = new SqlParameter("@BD_BudgetAmount", BudgetAmount);
            param[4] = new SqlParameter("BD_BudgetAmount_4_Months", BudgetAmount_4Months);
            param[5] = new SqlParameter("BD_InsertDate", InsertDate);
            param[6] = new SqlParameter("@PBD_Financial0BudgetAmount", Financial0BudgetAmount);
            param[7] = new SqlParameter("@PBD_Financial1BudgetAmount", Financial1BudgetAmount);
            param[8] = new SqlParameter("@PBD_Financial2BudgetAmount", Financial2BudgetAmount);
            param[9] = new SqlParameter("@PBD_Financial3BudgetAmount", Financial3BudgetAmount);
            param[10] = new SqlParameter("@PBD_Financial4BudgetAmount", Financial4BudgetAmount);
            ds = SqlHelper.ExecuteDataset(con, CommandType.StoredProcedure, "Accounts.InsertOrUpdateAccountBudget", param);
            SKey = "";
        }
        catch (Exception ex)
        {
    ...
    [WebMethod]
    public DataSet GetBudgetDetailsForExpenditure(string SKey, int InstId, int FinancialYearId)
    {
        try
        {
            param = new SqlParameter[2];
            param[0] = new SqlParameter("@InstId", InstId);
            param[1] = new SqlParameter("@FinancialYearId", FinancialYearId);
            ds = SqlHelper.ExecuteDataset(con, CommandType.StoredProcedure, "Accounts.GetBudgetDetailsForExpenditure", param);
            SKey = "";
        }
        catch (Exception ex)
        {
    ...
    [WebMethod]
    public DataSet GetBudgetDetailsForIncome(string SKey, int InstId, int FinancialYearId)
    {
        try
        {
            param = new SqlParameter[2];
            param[0] = new SqlParameter("@InstId", InstId);
            param[1] = new SqlParameter("@FinancialYearId", FinancialYearId);
            ds = SqlHelper.ExecuteDataset(con, CommandType.StoredProcedure, "Accounts.GetBudgetDetailsForIncome", param);
            SKey = "";
        }
        catch (Exception ex)
        {
